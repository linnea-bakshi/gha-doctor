...
- Flaky test names (`--flaky-logs N`) come **only from failed runs whose
  ...
  failure-summary formats ([26 framework families](flaky-frameworks.md):
  ...
  swift-testing, LLVM lit, meson test, GoogleTest, CTest, bazel, cargo-nextest, node-core test.py);
