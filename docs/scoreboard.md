...
_Snapshot: 2026-07-29 · gha-doctor 0.11.0 · last 100 completed runs per repo._
...
| [pytorch/pytorch](https://github.com/pytorch/pytorch) | **C** | 79/100 | wasted minutes (−8.4): 17% of sampled compute minutes went to failed runs or retries |
| [apache/airflow](https://github.com/apache/airflow) | **C** | 76/100 | workflow hygiene (−9.7): 42 warning(s), 14 info finding(s) across 47 file(s) |
| [cli/cli](https://github.com/cli/cli) | **C** | 71/100 | workflow hygiene (−24): 30 warning(s), 5 info finding(s) across 13 file(s) |
| [huggingface/transformers](https://github.com/huggingface/transformers) | **C** | 71/100 | workflow hygiene (−19.1): 102 warning(s), 27 info finding(s) across 57 file(s) |
| [vuejs/core](https://github.com/vuejs/core) | **C** | 70/100 | workflow hygiene (−15.3): 13 warning(s), 3 info finding(s) across 9 file(s) |
| [rust-lang/rust](https://github.com/rust-lang/rust) | **D** | 66/100 | workflow hygiene (−17.5): 7 warning(s), 0 info finding(s) across 4 file(s) |
| [angular/angular](https://github.com/angular/angular) | **D** | 65/100 | workflow hygiene (−26.2): 34 warning(s), 0 info finding(s) across 13 file(s) |
| [nodejs/node](https://github.com/nodejs/node) | **D** | 65/100 | workflow hygiene (−24.4): 99 warning(s), 14 info finding(s) across 42 file(s) |
| [grafana/grafana](https://github.com/grafana/grafana) | **D** | 63/100 | workflow hygiene (−22.6): 131 warning(s), 18 info finding(s) across 60 file(s) |
...
| [microsoft/vscode](https://github.com/microsoft/vscode) | **D** | 60/100 | workflow hygiene (−30): 50 warning(s), 16 info finding(s) across 16 file(s) |
...
| [pola-rs/polars](https://github.com/pola-rs/polars) | **F** | 59/100 | workflow hygiene (−27.1): 52 warning(s), 9 info finding(s) across 20 file(s) |
...
| [denoland/deno](https://github.com/denoland/deno) | **F** | 48/100 | workflow hygiene (−30): 35 warning(s), 51 info finding(s) across 11 file(s) |
...
| [astral-sh/uv](https://github.com/astral-sh/uv) | **F** | 47/100 | workflow hygiene (−21.3): 64 warning(s), 51 info finding(s) across 36 file(s) |
| [home-assistant/core](https://github.com/home-assistant/core) | **F** | 46/100 | workflow hygiene (−30): 47 warning(s), 25 info finding(s) across 13 file(s) |
