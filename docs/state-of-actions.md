...
*Generated 2026-08-01 by [`gha-doctor 0.36.0`](https://github.com/linnea-bakshi/gha-doctor)
...
| Workflow files linted | **2473** (median 6/repo) |
| Total findings | **7276** |
| Median findings per file | **2.9** |
...
|------|---------------|------:|--:|---------:|
| [D002](rules.md#d002-nojobtimeout) | job without timeout-minutes (a hang bills the 6h default) | 200 | 97% | 3526 |
...
| [D014](rules.md#d014-topofhourcron) | cron pinned to minute 0 (GitHub peak-load delays/drops) | 97 | 47% | 296 |
...
- **97% of repos have jobs with no `timeout-minutes`** (3526 jobs). A hung job bills the full 6-hour default before dying. Largest single repo: `langflow-ai/langflow` with 127.
